 ...
 * Programming Practice 1
        ...
        My goal with this program was to get better at file IO in C.
        This program is a basic database that allows you add entries in the formal of a title and entry body.
        There isn't to much complex about this program. I would with the stdin and used fgets to assure that I can capture a full sentences with spaces.
        <Reflection 2 Were you successful? Why or Why not?>
        Yes I felt like I was successful.
        There is a small bug where if you enter any characters besides numbers inside the commandline, the while loop turns infinite.
        I did successfully work on my file IO and in the end it worked out very well.
        <Reflection 3 Would you do anything differently if starting this program over?  If so, explain what.>
        I do not think that I would do anything different if I started over. I outlined this program pretty well so I didn't really have an issue.
        ...
        I think that the most important thing that I learned from writing this code was the pre-code outlining.
        Due to outlining the problem and finding the best way to solve it, the coding went much faster and there wasn't as much frustration
        as there would have been if I didn't outline the program.
